...
<aside class="w-24 bg-white border-r border-gray-200 flex flex-col items-center py-6 z-20 shadow-sm flex-shrink-0">
    ...
    <a href="indexowner.php" class="p-4 mb-4 rounded-xl transition duration-200 group relative
       <?= ($page == 'indexowner.php') ? 'bg-blue-50 text-blue-600 shadow-sm' : 'text-gray-400 hover:bg-gray-50 hover:text-gray-600' ?>">
